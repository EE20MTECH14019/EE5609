...
%
\begin{lstlisting}
https://github.com/EE20MTECH14019/EE5609/tree/master/QR_Decomposition
\end{lstlisting}
and all python codes from 
\begin{lstlisting}
https://github.com/EE20MTECH14019/EE5609/tree/master/QR_Decomposition/codes
\end{lstlisting}
%
\section{Problem}
Perform QR decomposition of matrix $\myvec{3&-1\\-4&2}$
\section{Explanation}
...
\end{align}
\begin{align}
    \text{where, orthogonal matrix } \vec{U}=\myvec{\vec{u_1}&\vec{u_2}}\\
    \text{Right-triangular matrix, }
